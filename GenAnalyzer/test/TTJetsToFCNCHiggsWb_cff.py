...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    #fileName = cms.untracked.string('/tmp/naodell/TToFCNHToWW_M-125_TuneZ2_8TeV_pythia6_v1.root'),
    fileName = cms.untracked.string('/tmp/naodell/test_gen.root'),
...
process.dileptonFilter = cms.EDFilter("MCParticlePairFilter",
    ...
    MinPt   = cms.untracked.vdouble(10., 3.),
    ParticleID1 = cms.untracked.vint32(-11, 11),# -13, -15, 11, 13, 15),
    ParticleID2 = cms.untracked.vint32(-11, 11)#, -13, -15, 11, 13, 15)
#    MaxInvMass = cms.untracked.double(120.0),
#    MinInvMass = cms.untracked.double(70.0)
)
...
process.generation_step = cms.Path(process.pgen * process.dileptonFilter * process.demo)
